...
<div class="container-fluid">
    <div class="zulu-toolbar-row">
        <div class="btn-group">
            <button class="btn btn-danger" form="element-delete-form" type="submit">
                <span class="me-1" aria-hidden="true"><i class="fa-solid fa-trash"></i></span>
                <?php echo Lang::get('FFCMS_DELETE'); ?>
            </button>
            <a class="btn btn-outline-secondary" href="/admin/elements">
    ...
    <div class="zulu-panel">
        ...
        <p><?php echo Template::escape($element['title'] ?? ''); ?></p>
        <form id="element-delete-form" method="post">
            <?php echo Csrf::input(); ?>
        </form>
    </div>
</div>
